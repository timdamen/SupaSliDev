...
Supaslidev uses pnpm's catalog feature to centralize dependency versions across all presentations. This page explains how version management works and how to use it effectively.
