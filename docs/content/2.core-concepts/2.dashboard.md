...
### pnpm dashboard new \[name\]

Creates a new presentation in the workspace.

```bash
pnpm dashboard new quarterly-review
```
...
| `pnpm dashboard present <name>` | Start dev server for one presentation |
